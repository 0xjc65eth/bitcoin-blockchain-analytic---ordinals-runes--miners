...
export function Ordinals() {
  const { ordinalsVolume, ordinalsPrice } = useMarket();
  ...
  return (
    <Layout>
      <div className="space-y-6">
        <h1 className="font-orbitron text-3xl text-blue-400 mb-6">Ordinals Analytics</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-gray-800/80 backdrop-blur-md p-6 rounded-lg">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-2xl font-bold">{ordinalsVolume?.toLocaleString()} BTC</p>
              </div>
              <div>
                <p className="text-gray-400">Average Price</p>
                <p className="text-2xl font-bold">{ordinalsPrice?.toLocaleString()} sats</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-800/80 backdrop-blur-md p-6 rounded-lg">
            ...
            <div className="space-y-4">
              <div>
                <p className="text-gray-400">Pending Inscriptions</p>
